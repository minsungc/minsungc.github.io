...
\href{https://minsungc.github.io}{\texttt{minsungc.github.io}} \\
\href{https://linkedin.com/in/minsung-c}{\texttt{linkedin.com/in/minsung-c}}
\end{tabbing}}

\vspace{2pt}
\noindent Software engineer working on compilers, database engines, and distributed systems.
...
{Software Engineer, Compiler}
{
    ...
    \begin{itemize}
        \item Scale adoption from internal algorithms to several enterprise workloads (15k queries/day)
        \item Cut day-long query runtimes to under an hour
    \end{itemize}
    \item Lead migration of legacy customer code ($>$300k LoC) to our Python library, partnering with GTM
    \begin{itemize}
        \item Build a compiler toolchain to incrementally transpile legacy code
        \item Accelerate benchmark workloads up to 30\% by eliminating costly legacy compiler passes
    \end{itemize}
    \item Ship GQL-style graph pattern matching as sole compiler engineer with the Symbolic AI team
    \item Maintain the database engine's Protocol Buffer-based entry point (100k+ queries/day)
}
...
{R\&D Intern}
{
    \item Shipped a decompiler that lifts optimized Datalog back to the source query
...
\begin{description}\setlength{\itemsep}{2pt}\setlength{\parskip}{0pt}\setlength{\topsep}{0pt}
    ...
    \item[Tools:] Unix, Git, Docker, Datadog, Observe, Snowflake, LLVM/MLIR
\end{description}
