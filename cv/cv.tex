...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
  ...
  \begin{minipage}[t]{\linewidth}
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          \item[-] Working in the intersection of probabilistic program semantics and knowledge compilation
      \end{itemize}
      \end{minipage}
  }
  \end{tabularx}
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        \item[-] Classified an extension of certain quasi-differential operators on a Hilbert space
